celltype_colours = {
                      ...
                      "Mesothelium-endothelium/Masked":"blue",
...
def getCelltypePalette():
    """ Returns a dictionary of cell type colours in Hex format. """
    return(celltype_colours)


def getClusterPalette():
    """
    Returns a list of godsnot colours to use for clustering results. 
